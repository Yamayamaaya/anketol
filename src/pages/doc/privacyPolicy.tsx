...
const markdown = `
# プライバシーポリシー
「アンケトル」（以下，「当サービス」といいます。）は、Googleフォームを活用したアンケート管理・共有のウェブサービスです。当サービスは、ユーザーがGoogleアカウントでログインし、当サービスのアドオンをGoogleフォームにインストールすることにより、フォームの情報および回答者の情報を収集します。本ポリシーでは、当サービスがどのようにユーザーの個人情報を取り扱うかについて定めます。
...
当サービスは、ユーザーが利用登録をする際に氏名、メールアドレスなどの個人情報をお尋ねします。また、当サービスのアドオンを通じて、ユーザーが作成したGoogleフォームの内容およびアンケート回答者の情報を収集します。
